...
public class ChatHeadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Note: chatHeadImage will be set later in onCreate() or in the delayed handler
        ...
        handler.postDelayed(() -> {
            // Set chat head image if provided
    ...
    public void onCreate() {
        ...
        // Start foreground service immediately in onCreate to prevent any timing issues
        startForegroundService();
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                NotificationChannel defaultChannel = new NotificationChannel("default", "Default", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    private void startForegroundService() {
        if (isForegroundStarted) {
            return; // Already started as foreground service
        }
        ...
        try {
            ...
            Notification notification = new NotificationCompat.Builder(this, channelId)
                    ...
                    .setContentText(notificationBody == null ? "Service is running" : notificationBody)
                    .setOngoing(true)
            ...
            e.printStackTrace();
            // If there's an error, try with a basic notification
            try {
                Notification basicNotification = new NotificationCompat.Builder(this, "default")
                        .setSmallIcon(R.drawable.logo)
                        .setContentTitle("Service Running")
                        .setContentText("Chat head service is active")
                        .setPriority(NotificationCompat.PRIORITY_HIGH)
                        .build();
