    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400) {
          // Show user-friendly error message for country list
          String errorMessage = 'Failed to load country list. Please try again.';
          if (response.data["message"] != null && response.data["message"].toString().isNotEmpty) {
            // If server provides a specific message, use it, otherwise use default
  ...
  Future<Either<Failure, VeifyUserResponseModel>> verifyUser(
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400) {
          // Show user-friendly error message for user verification
          String errorMessage = 'User verification failed. Please check your details.';
          if (response.data["message"] != null && response.data["message"].toString().isNotEmpty) {
            // If server provides a specific message, use it, otherwise use default
            errorMessage = response.data["message"].toString();
          }
  ...
  Future<Either<Failure, CommonModuleModel>> commonModuleCheck() async {
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400) {
          // Show user-friendly error message for common module check
          String errorMessage = 'Module check failed. Please try again.';
          if (response.data["message"] != null && response.data["message"].toString().isNotEmpty) {
            // If server provides a specific message, use it, otherwise use default
            errorMessage = response.data["message"].toString();
          }
  ...
  Future<Either<Failure, SendMobileOtpResponseModel>> sendMobileOtp(
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400) {
          // Show user-friendly error message for sending OTP
  ...
  Future<Either<Failure, dynamic>> verifyMobileOtp(
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode! >= 400) {
          // Show user-friendly error message for OTP verification
          String errorMessage = 'Entered wrong OTP';
          if (response.data["message"] != null && response.data["message"].toString().isNotEmpty) {
            // If server provides a specific message, use it, otherwise use default
            errorMessage = response.data["message"].toString();
          }
  ...
  Future<Either<Failure, dynamic>> updatePassword(
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400) {
          // Show user-friendly error message for password update
    ...
    try {
      ...
      if (response.data == null || response.data == '') {
        ...
        if (response.statusCode == 400 ||
            response.statusCode == 422 ||
            response.statusCode == 500) {
          // Show user-friendly error message for referral code
          String errorMessage = 'Invalid referral code. Please check and try again.';
          if (response.data["message"] != null && response.data["message"].toString().isNotEmpty) {
            // If server provides a specific message, use it, otherwise use default
            errorMessage = response.data["message"].toString();
          }
